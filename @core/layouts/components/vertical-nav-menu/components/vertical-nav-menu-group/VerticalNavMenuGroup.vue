...
export default {
  ...
  mounted() {
    if((this.isArrayIntersect(this.item.accessPage, this.$session.get('accessHumanTask'))).length == 0 && this.item.accessPage != 'all' && JSON.parse(this.$session.get('userData')).username != 'superadmin' ){
