...
export default {
  ...
  mounted: function () {
    // console.log(this.$session.get('accessHumanTask'))
    this.showLink = ((this.isInArray(this.item.accessPage, this.$session.get('accessHumanTask'))) || this.item.accessPage == 'all' || JSON.parse(this.$session.get('userData')).username == 'superadmin')
  },
  methods: {
