<template>
  <div>
    ...
    <v-dialog v-model="formCalculateTax" persistent width="500">
      <v-card>
        <v-card-title class="headline">
    ...
    <v-row>
      <v-col cols="12" class="mb-0">
        <v-card outlined>
          <v-card-title>
            <span>Input Sales Order Invoice</span>
            <v-spacer></v-spacer>
            <v-chip
              small
              :class="`${
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12" md="6" class="pb-0 mt-2 mt-2">
              ...
              <v-col cols="12" class="pb-0">
                <v-card outlined>
                  <v-card-title>
                    ...
                    <!--                        small-->
                    <!--                        color="info"-->
                    <!--                        v-show="form.flgTax == 'Y' && (form.taxId != '' || form.taxId != null) && !formEdit"-->
    ...
    getDetail(id) {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.form.flgTax = response.data.result.invoiceTax[0].flgTax;
      ...
      axios
        .post(
          `${themeConfig.app.api_sl}/sales-invoice/add`,
          {
            ...
            flgTax: this.form.flgTax,
            typeTax: this.form.taxid,
            paymentAmount: "",
            taxAmount: "",
            taxList: [],
            itemList: [],
