      ...
      <v-row>
        <v-col cols="12" md="4" class="pb-0">
          <app-autocomplite-ou-company
            ...
            :ou-type="
              filterType == 'DRAFT'
                ? 'conversionCashBankInPartnerReceiveDraft'
                : filterType == 'INPROGRESS'
                ? 'conversionCashBankInPartnerReceiveInProgress'
                : 'conversionCashBankInPartnerReceiveApproved'
            "
          ></app-autocomplite-ou-company>
        </v-col>
        <v-col cols="12" md="4" class="pb-0">
...
export default {
  ...
  methods: {
    refreshData() {
      this.$root.$emit("filterInvoiceARPartnerReceiveDoc", this.form);
    },
  },
};
</script>
